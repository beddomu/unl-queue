        ...
        if str(interaction.user.id) in unlq['players']:
            if interaction.user.id not in self.queue.get_all_ids():
                if unlq['players'][str(interaction.user.id)]['banned_until'] < time.time():
                    if is_player_gold_plus(unlq['players'][str(interaction.user.id)]['id']) or interaction.user.id in [301821822502961152, 300052305540153354, 178867201753743360, 450720749439811585]:
                    #if True:
